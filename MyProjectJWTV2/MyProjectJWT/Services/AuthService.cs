    ...
    public class AuthService : IAuthService
    {
        ...
        public UserDTO AddUser(CreateUserDTO userDto)
        {
            ...
            var user = new User
            {
                ...
                ContactNumber = userDto.ContactNumber // Set ContactNumber
            };
        ...
        public UserDTO UpdateUser(int id, UpdateUserDTO userDto)
        {
            ...
            user.ContactNumber = userDto.ContactNumber; // Update ContactNumber
            ...
            return new UserDTO
            {
                ...
                LastName = user.LastName,
                Email = user.Email,
                ContactNumber = user.ContactNumber, // Include updated ContactNumber
