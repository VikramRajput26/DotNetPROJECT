...
namespace MyProjectJWT.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        [HttpPost("assignRole")]
        public IActionResult AssignRoleToUser([FromBody] AddUserRole addUserRole)
        {
            if (addUserRole == null)
                return BadRequest("Role assignment data is null.");

            try
            {
                var success = _auth.AssignRoleToUser(addUserRole);
        ...
        public IActionResult AddRole([FromBody] Role role)
        {
            ...
            try
            {
                ...
                return CreatedAtAction(nameof(AddRole), new { id = addedRole.RoleId }, addedRole);
            }
            catch (Exception ex)
            {
                return BadRequest(ex.Message);
